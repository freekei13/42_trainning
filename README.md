# 42 Lausanne — csamakka

*This repository contains all projects completed as part of the 42 curriculum by [csamakka].*
...
- **C programming** — memory management, pointers, file descriptors
- **Algorithms** — sorting, parsing, data structures
- **Unix/Linux** — processes, signals, pipes, system calls
- **Concurrency** — threads, mutexes, race condition prevention
- **System administration** — virtual machines, networking basics
